...
class TestExpiration(unittest.TestCase):
    ...
    def test_expirationyaml(self):
        ...
        test_file_yaml = yaml.dump({'rules':[{'location':'192.168.0.2/32','ports':443,'expiration':seconds_to_wait},{'location':'192.168.0.3/32','ports':443,'expiration':2*seconds_to_wait}]}, default_flow_style=False)
